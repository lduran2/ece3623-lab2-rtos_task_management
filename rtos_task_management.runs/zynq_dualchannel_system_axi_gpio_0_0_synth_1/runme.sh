...
HD_PWD='C:/Zynq_Book/rtos_task_management/rtos_task_management.runs/zynq_dualchannel_system_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_dualchannel_system_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_dualchannel_system_axi_gpio_0_0.tcl
