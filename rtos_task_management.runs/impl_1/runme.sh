...
EAStep vivado -log zynq_dualchannel_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_dualchannel_system_wrapper.tcl -notrace
