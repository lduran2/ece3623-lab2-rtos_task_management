...
HD_PWD='C:/Zynq_Book/rtos_data_queue_on_zybo/rtos_task_management.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_dualchannel_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_dualchannel_system_wrapper.tcl
