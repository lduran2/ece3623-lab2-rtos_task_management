...
HD_PWD='C:/Zynq_Book/rtos_task_management/rtos_task_management.runs/zynq_dualchannel_system_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_dualchannel_system_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_dualchannel_system_rst_ps7_0_100M_0.tcl
